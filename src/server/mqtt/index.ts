...
export function getMqttService(): MqttService {
  ...
  if (!mqttServiceInstance.isClientConnected()) mqttServiceInstance.reconnect()
  console.log('call get mqtt service isClientConnected', {
    isClientConnected: mqttServiceInstance.isClientConnected(),
  })
